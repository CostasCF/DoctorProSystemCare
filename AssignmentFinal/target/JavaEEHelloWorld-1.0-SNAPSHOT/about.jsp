    ...
    <div class="agileits-wthree-about py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
               <h3 class="w3l-sub">About Us</h3>
				<h4 class="sub-title py-3">Below is some basic information about our hospital</h4>
			</div>
            <div class="agileits-wthree-about-row row py-lg-5  no-gutters">
                <div class="col-lg-4">
                    <div class="agileits-wthree-about-grids">
                        <span class="fas fa-sitemap"></span>
                        <h4 class="my-2">High Tech
                        </h4>
                        <p>Here at Doctor Pro it is a priority for us to always be up to date with the latest medical
                        equipment and technology in order to provide revolutionary methods to save lives</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="agileits-wthree-about-grids mt-lg-0 my-5 px-lg-5">
                        <span class="fas fa-chart-area"></span>
                        <h4 class="my-2">Constant Growth
                        </h4>
                        <p>Our hospital started as a small local healthcare institution but is has progressed it's constantly
                        developing with a sole purpose of saving as many lives as possible</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="agileits-wthree-about-grids  pl-lg-5">
                        <span class="fas fa-globe"></span>
                        <h4 class="my-2">International knowledge
                        </h4>
                        <p>We have employed the best doctors from around the world</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="team py-lg-5">
            ...
            <div class="text-center wthree-title pb-sm-5 pb-3">
               <h3 class="w3l-sub">Our Staff</h3>
				<h4 class="sub-title py-3">The first doctors we ever employed</h4>
			</div>
            <div class="row my-sm-5">
                <div class="col-lg-4 col-sm-6">
                    <div class="box16">
                        <img src="images/doctorLefteris.png" alt="" class="img-fluid" />
                        <div class="box-content">
                            <h3 class="title">Lefteris Kontouris</h3>
                            <span class="post">Internist</span>
                            <ul class="social">
                                <li>
                                    <a href="#">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="box16">
                        <img src="images/doctorMichalis.jpg" alt="" class="img-fluid" />
                        <div class="box-content">
                            <h3 class="title">Michail Stylianidis</h3>
                            <span class="post">Ophthalmologist</span>
                            <ul class="social">
                                <li>
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
                ...
                <div class="col-lg-4 col-sm-6 mx-auto mt-lg-0 mt-sm-5">
                    <div class="box16">
                        <img src="images/doctorKostas.png" alt="" class="img-fluid" />
                        <div class="box-content">
                            <h3 class="title">Kostas Kalogeropoulos</h3>
                            <span class="post">Pediatric</span>
                            <ul class="social">
                                <li>
                                    <a href="#">
                                        <i class="fab fa-facebook-f"></i>
